<?php
/**
 * Aseel functions and definitions
 *
...
/**
 * Aseel only works in WordPress 4.7 or later.
 */
...
function aseel_setup() {
	 ...
	 * Translations can be filed at WordPress.org. See: https://translate.wordpress.org/projects/wp-themes/aseel
	 * If you're building a theme based on Aseel, use a find and replace
	 * to change 'aseel' to the name of your theme in all the template files.
	 */
	...
	/**
	 * Filters Aseel array of starter content.
	 *
	 * @since Aseel 1.1
	 *
...
function aseel_content_width() {
	...
	/**
	 * Filter Aseel content width of the theme.
	 *
	 * @since Aseel 1.0
	 *
