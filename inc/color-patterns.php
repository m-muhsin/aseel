 ...
 */
function aseel_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Aseel default saturation level.
	 *
	 * @since Aseel 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'aseel_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.aseel-front-page) .entry-title,
...
.colors-custom .aseel-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.aseel-front-page .panel-content .recent-posts article,
...
.colors-custom.aseel-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Aseel custom colors CSS.
	 *
	 * @since Aseel 1.0
	 *
	 ...
	 */
	return apply_filters( 'aseel_custom_colors_css', $css, $hue, $saturation );
}
